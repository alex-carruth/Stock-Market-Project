...
poly.fit(poly.fit(X_train_poly, Y_train))
poly_regressor = LinearRegression()
poly_regressor.fit(X_train_poly, Y_train)
prediction = poly.regressor.predict(X_test)
Y_pred = poly_regressor.predict(X_pred)
print(prediction)
print(scalerY.inverse_transform(prediction))
print('Prediction Score: ', poly_regressor.score(X_test, Y_test))
